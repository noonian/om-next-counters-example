...
var x__7789__auto__ = (((x == null))?null:x);
var m__7790__auto__ = (sablono.util.to_str[goog.typeOf(x__7789__auto__)]);
if(!((m__7790__auto__ == null))){
return m__7790__auto__.call(null,x);
} else {
var m__7790__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__7790__auto____$1 == null))){
return m__7790__auto____$1.call(null,x);
} else {
...
var x__7789__auto__ = (((x == null))?null:x);
var m__7790__auto__ = (sablono.util.to_uri[goog.typeOf(x__7789__auto__)]);
if(!((m__7790__auto__ == null))){
return m__7790__auto__.call(null,x);
} else {
var m__7790__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__7790__auto____$1 == null))){
return m__7790__auto____$1.call(null,x);
} else {
...
var len__8245__auto___9572 = arguments.length;
var i__8246__auto___9573 = (0);
while(true){
if((i__8246__auto___9573 < len__8245__auto___9572)){
args__8252__auto__.push((arguments[i__8246__auto___9573]));

var G__9574 = (i__8246__auto___9573 + (1));
i__8246__auto___9573 = G__9574;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__8253__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq9571){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq9571));
});
...
var vec__9575 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
...
var first_word = first__9577;
var words = seq__9576__$1;
...
var G__9578 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__9578,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono.util.camel_case_keys);
} else {
return G__9578;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__9579_SHARP_){
if(typeof p1__9579_SHARP_ === 'string'){
return p1__9579_SHARP_;
} else {
return cljs.core.seq.call(null,p1__9579_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__7120__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1500356351900